...
export const PrivacyPolicy = () => {
  return (
    <>
      <div>
        <div>
          <em>창규's 블로그('https://lemonsoju.blog')</em>는 「개인정보 보호법」
          제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을
          신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보
          처리방침을 수립·공개합니다.
        </div>
        <div>
          이 개인정보처리방침은 <em>2023</em>년 <em>6</em>월 <em>25</em>부터
          적용됩니다.
        </div>
        <br />
        <div>
          <strong>
            ...
            <br />
            <br />
            <em>창규's 블로그</em>는 다음의 목적을 위하여 개인정보를 처리합니다.
        ...
        <div>
          ...
          <br />
          <br />① <em>창규's 블로그</em>는 법령에 따른 개인정보 보유·이용기간
        ...
        <ul>
          ...
          <li>
            홈페이지 회원가입 및 관리와 관련한 개인정보는 관련법령에 의거하여
            수집.이용에 관한 동의일로부터 탈퇴 시까지 위 이용목적을 위하여
            보유.이용됩니다.
          </li>
        </ul>
        <br />
        ...
        <div>
          ...
          <br />
          <br />① <em>창규's 블로그</em>는 다음의 개인정보 항목을 처리하고
          있습니다.
        </div>
        <ul>
          <li>1. 홈페이지 회원가입 및 관리</li>
          <li>필수항목 : 로그인ID, 비밀번호</li>
          <li>선택항목 : -</li>
        </ul>
        <br />
        <br />
        ...
        <div>
          <br />
          ① 창규's 블로그는 개인정보 보유기간의 경과, 처리목적 달성 등
          ...
          보관장소를 달리하여 보존합니다. 별도 보존되는 개인정보는 법률에 의한
          경우가 아니고서는 보존목적 이외의 다른 목적으로 이용되지 않습니다.
          <br />
          <br />
          ...
          1. 파기절차
          <br />
          창규's 블로그는 파기 사유가 발생한 개인정보를 선정하고, 창규's
          블로그의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
          <br />
        </div>
        <div>2. 파기방법</div>
        <div>
      ...
      <br />
      <div>
        <strong>제5조(미이용자의 개인정보 파기 등에 관한 조치)</strong>
      </div>
      <div>
        <br />
        <br />
        ① 창규's 블로그는 1년간 서비스를 이용하지 않은 이용자의 정보를 파기하고
        ...
        <div>
          <br />
          <br />① 창규's 블로그는 이용자의 개인정보를 수집 시 명시한 범위
          내에서만 개인정보를 처리하며, 원칙적으로 이용자의 개인정보를 제3자에게
          제공하지 않습니다.
        </div>
        <div>
          <strong>
        ...
        <div>
          <br />
          <br />① 정보주체는 창규's 블로그에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </div>
        <div>
          ② 제1항에 따른 권리 행사는 창규's 블로그에 대해 「개인정보 보호법」
          시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여
          하실 수 있으며 창규's 블로그는 이에 대해 지체 없이 조치하겠습니다.
        </div>
        <div>
        ...
        <div>
          ⑥ 창규's 블로그는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <div>
          <br />
          <br />① 창규's 블로그는 이용자에게 개별적인 맞춤서비스를 제공하기 위해
          ...
          <div>
            {" "}
            ① <span>창규's 블로그</span>는 개인정보 처리에 관한 업무를 총괄해서
          ...
          <ul>
            <li>▶ 개인정보 보호책임자 </li>
            <li>성명 : 윤창규</li>
            <li>이메일 : yckk980320@naver.com</li>
          </ul>
          <div>
            ② 정보주체께서는 창규's 블로그의 서비스(또는 사업)을 이용하시면서
            발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한
            사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다.
            창규's 블로그는 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴
            것입니다.
          </div>
          <div>
            <strong>
              ...
              청구를 아래의 연락처로 할 수 있습니다.
              <br />
              <span>창규's 블로그</span>는 정보주체의 개인정보 열람청구가
              신속하게 처리되도록 노력하겠습니다.{" "}
            </strong>
          </div>
          <ul>
            <li>▶ 개인정보 열람청구 접수·처리 담당자 </li>
            <li>담당자 : 윤창규</li>
            <li>연락처 : yckk980320@naver.com </li>
          </ul>
          <br />
          <br />
          <div>
            <strong>
              제12조(정보주체의 권익침해에 대한 구제방법)<em></em>
            </strong>
          </div>
          <br />
          <br />
          ...
          <div>
            <strong>
              제13조(개인정보 처리방침 변경)<em></em>
            </strong>
          </div>
          <br />
        </div>
        <div>① 이 개인정보처리방침은 2023년 2월 24부터 적용됩니다.</div>
        <div>
